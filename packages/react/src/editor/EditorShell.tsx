  ...
  const sendAiMessage = useCallback(
    (prompt: string, scope: AiScope) => {
      ...
      const message: {
        ...
        type: "page.patch",
        requestId: "ai_1782262558775_4c54b5afba916",
        patch: [
          {
            op: "replacePage",
            page: {
              id: "page_home",
              title: "Fashion Ecommerce Home",
              version: 1,
              viewport: "desktop",
              props: {
                className:
                  "min-h-screen bg-[#f5f1eb] text-[#211f1b] antialiased",
              },
              sections: [
                {
                  ...
                  props: {
                    className:
                      "sticky top-0 z-50 h-[72px] bg-[#f5f1eb]/90 backdrop-blur-xl border-b border-[#211f1b]/10",
                  },
                  grid: {
                    columns: 12,
                    rows: 1,
                  ...
                  tools: [
                    {
                      id: "tool_navbar_1782288727715_58788cbaeccd3",
                      type: "navbar",
                      name: "Navbar",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        classNames: {
                          navbar: "h-full bg-transparent shadow-none",
                          "navbar-inner":
                            "h-full px-3 sm:px-5 md:px-10 lg:px-14",
                          "navbar-brand":
                            "font-serif text-xs tracking-[0.16em] text-[#211f1b] sm:text-lg sm:tracking-[0.22em] md:text-xl md:tracking-[0.28em]",
                          "navbar-nav-list":
                            "!hidden lg:!flex justify-center gap-5",
                          "navbar-nav-item":
                          ...
                          "navbar-mobile-panel":
                            "bg-[#f5f1eb] border-[#211f1b]/10",
                          "navbar-mobile-toggle":
                            "border-[#211f1b]/20 text-[#211f1b]",
                        },
                      },
                    },
                  ],
                },
                {
                  ...
                  tools: [
                    {
                      id: "tool_carousel_1782288727716_fd1a26ac231178",
                      type: "carousel",
                      name: "Carousel",
                      layout: {
                        gridArea: {
                        ...
                        items: [
                          {
                            ...
                            imgAlt: "模特演绎低饱和高级通勤穿搭 1",
                            title: "秋冬静奢新装",
                            description: "精选外套与针织，满 ¥1,200 享 9 折",
                          },
                          {
                            imgSrc:
                              "https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=2400&q=90",
                            imgAlt: "模特演绎低饱和高级通勤穿搭 2",
                            title: "羊毛、皮革与柔光廓形",
                            description: "以低饱和色阶完成全天候搭配",
                          },
                          {
                            imgSrc:
                              "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=2400&q=90",
                            imgAlt: "模特演绎低饱和高级通勤穿搭 3",
                            title: "都市周末胶囊衣橱",
                            description: "新品上架，限时会员双倍积分",
                          },
                        ],
                        classNames: {
                          carousel:
                            "relative overflow-hidden bg-[#ded7ca] shadow-[0_28px_80px_rgba(33,31,27,0.14)]",
                    ...
                    {
                      id: "tool_text_1782288727716_8eee7457191998",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        className:
                          "text-xs tracking-[0.34em] text-[#fbf8f1]/80",
                      },
                    },
                    {
                      id: "tool_button_1782288727716_c9ffa9741784a8",
                      type: "button",
                      name: "Button",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        type: "button",
                        className:
                          "rounded-full border border-[#fbf8f1] bg-[#fbf8f1] px-8 py-4 text-xs font-medium tracking-[0.22em] text-[#211f1b] hover:bg-transparent hover:text-[#fbf8f1]",
                      },
                    },
                  ],
                },
                {
                  id: "section_generated_3",
                  type: "section",
                  name: "Section 3",
                  props: {
                  ...
                  tools: [
                    {
                      id: "tool_text_1782288727716_e1f7234dcdbba8",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        content: "会员专享福利",
                        className:
                          "text-center text-xs tracking-[0.34em] text-[#8a7f72]",
                      },
                    },
                    {
                      id: "tool_card_1782288727716_624ea4948c752",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        title: "换季礼遇",
                        description:
                          "全场精选满 ¥899 减 ¥120；外套与靴履组合再享会员积分。",
                        buttonLabel: "查看活动",
                        classNames: {
                          card: "bg-[#211f1b] px-7 py-8 text-[#f8f4ee] md:px-12 lg:px-16",
                          "card-header": "max-w-4xl",
                          "card-title":
                            "font-serif text-4xl tracking-[-0.03em] md:text-6xl",
                          "card-description":
                ...
                },
                {
                  ...
                  tools: [
                    {
                      id: "tool_text_1782288727716_c0d73286dde93",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        content: "分类穿搭",
                        className:
                          "font-serif text-4xl tracking-[-0.03em] md:text-5xl",
                      },
                    },
                    {
                      id: "tool_text_1782288727716_e80f34952de7f",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        content:
                          "以通勤、周末、晚间三个场景组织衣橱，减少选择成本。",
                        className:
                          "self-end text-sm leading-7 tracking-[0.08em] text-[#6d665d]",
                      },
                    },
                    {
                      id: "tool_card_1782288727716_4c08e2c9a1e118",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        classNames: {
                          ...
                          "card-description":
                            "mt-2 text-sm tracking-[0.12em] text-[#7b7166]",
                    ...
                    {
                      id: "tool_card_1782288727716_9cc008718f1878",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727716_194341931786d",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                ...
                },
                {
                  ...
                  tools: [
                    {
                      id: "tool_text_1782288727716_0d6aa511d35c68",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        content: "爆款推荐 / 新品上架",
                        className:
                          "text-center font-serif text-4xl tracking-[-0.03em] md:text-5xl",
                      },
                    },
                    {
                      id: "tool_card_1782288727716_0ccc3231cbb948",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727716_9e961f3e611198",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727716_f1d6b2c719ad8",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727716_df878b618e2208",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727717_1bea366b7631a",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727717_8920de9a9a034",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727717_c7f28eaa705e38",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_card_1782288727717_4bb3520ac24ac",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                ...
                },
                {
                  ...
                  tools: [
                    {
                      id: "tool_card_1782288727717_88e09e0942093",
                      type: "card",
                      name: "Card",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        title: "场景搭配指南",
                        description:
                          "从晨间会议到夜间聚会，用三件核心单品完成一日衣橱。",
                        buttonLabel: "阅读指南",
                        classNames: {
                          card: "bg-[#ebe5dc]",
                          "card-img":
                            "h-[520px] w-full object-cover saturate-[0.72]",
                          "card-header": "p-7",
                    ...
                    {
                      id: "tool_text_1782288727717_16bbbdabd0204",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        className: "text-lg leading-8 tracking-[0.06em]",
                      },
                    },
                    {
                      id: "tool_divider_1782288727717_0cc4ed253f0358",
                      type: "divider",
                      name: "Divider",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        orientation: "horizontal",
                        className: "border-[#211f1b]/20",
                      },
                    },
                    {
                      id: "tool_text_1782288727717_99097d06ec4168",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_divider_1782288727717_d6042c8793ecc8",
                      type: "divider",
                      name: "Divider",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_text_1782288727717_bed8e9e3ab3fa",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                ...
                },
                {
                  ...
                  props: {
                    className:
                      "bg-[#211f1b] px-4 py-12 text-[#f8f4ee] md:px-8 lg:px-14",
                  },
                  grid: {
                    columns: 12,
                    rows: 6,
                  ...
                  tools: [
                    {
                      id: "tool_text_1782288727717_00528cd11cfbe8",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_text_1782288727717_ad0d54270edca",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        content:
                          "低饱和高级成衣与日常衣橱方案。我们提供 7 日无理由退换、门店修改与会员专属搭配咨询。",
                        className:
                          "text-sm leading-7 tracking-[0.08em] text-[#d7cfc4]",
                      },
                    },
                    {
                      id: "tool_text_1782288727717_56802bf7bf4b08",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                      ...
                      props: {
                        ...
                        className:
                          "whitespace-pre-line text-sm leading-7 tracking-[0.08em] text-[#d7cfc4]",
                      },
                    },
                    {
                      id: "tool_text_1782288727717_dde1cc4cd99c98",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_text_1782288727717_2d0cbf4cda3ae",
                      type: "text",
                      name: "Text",
                      layout: {
                        gridArea: {
                    ...
                    {
                      id: "tool_social_1782288727717_9dca90da4f3748",
                      type: "social",
                      name: "Social",
                      layout: {
                        gridArea: {
