import type { SitePatchBundle } from "./sitePatch.ts";
...
// Deterministic, dependency-free SHA-256 for browser/server parity.
...
export function computeBundleDigest(
  bundle: Omit<SitePatchBundle, "bundleDigest"> | SitePatchBundle,
) {
  const { bundleDigest: _ignored, ...digestible } = bundle as SitePatchBundle;
