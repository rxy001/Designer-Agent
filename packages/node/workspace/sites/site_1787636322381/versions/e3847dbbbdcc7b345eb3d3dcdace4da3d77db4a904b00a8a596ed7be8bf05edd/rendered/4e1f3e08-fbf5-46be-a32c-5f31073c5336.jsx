import { Accordion, Badge, Button, Card, Carousel, Divider, Image, Navbar, Root, Section, Text } from "@/components";

export default function App() {
  return (
    <Root >
      <Section id="site_header_section" columns={12} rows={1} height={72} columnGap={12} rowGap={12} responsive={{
        tablet: {
          height: 72
        },
        mobile: {
        ...
        <Navbar brand="优雅女装品牌" sticky showMobileMenu classNames={{
      ...
      <Section id="site_footer_section" columns={12} rows={4} height={260} columnGap={12} rowGap={12} responsive={{
        tablet: {
          rows: 4,
          height: 260
        },
