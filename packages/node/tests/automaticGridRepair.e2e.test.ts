...
test(
  ...
  async (t) => {
    ...
    try {
      ...
      await unregisterPreviewArtifact(verticalSandboxPath);
      await unregisterPreviewArtifact(horizontalSandboxPath);
      await unregisterPreviewArtifact(multiToolSandboxPath);
      await unregisterPreviewArtifact(reflowSandboxPath);
      await unregisterPreviewArtifact(tabletSandboxPath);
      await unregisterPreviewArtifact(sectionHeightSandboxPath);
      await unregisterPreviewArtifact(boundsSandboxPath);
      await unregisterPreviewArtifact(cardActionsSandboxPath);
      await unregisterPreviewArtifact(trailingRowsSandboxPath);
      await unregisterPreviewArtifact(intentionalSpaceSandboxPath);
